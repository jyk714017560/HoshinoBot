...
CHARA_NAME = {
    ...
    1118: ["贪吃佩可(新年)", "ペコリーヌ(ニューイヤー)", "Pekoriinu(NewYear)", "春佩可", "春吃", "春吃货"],
    ...
    1145: ["咲恋(圣诞节)", "サレン(クリスマス)", "Saren(Xmas)","圣电","圣诞充电宝"],
    1146: ["优花梨(圣诞节)", "ユカリ(クリスマス)", "Yukari(Xmas)","蛋黄","圣黄骑","圣诞黄骑"],
    1147: ["矛依未(新年)", "ムイミ(ニューイヤー)", "Muimi(NewYear)","春511","春矛"],
    ...
    1801: ["日和(公主)", "ヒヨリ(プリンセス)", "Hiyori(Princess)", "公主猫拳", "创燃高达", "公猫", "公主猫"],
