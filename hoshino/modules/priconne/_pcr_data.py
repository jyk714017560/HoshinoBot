...
CHARA_NAME = {
    ...
    1310: ["真步（梦想乐园）", "マホ（ドリームパーク）", "Maho(DreamPark)", "兔壶","烧壶","兔狐"],
    ...
    1337: ["菈比莉斯塔（始原）", "ラビリスタ（アルファ）", "Rabirisuta(Alpha)", "水晶", "α晶"],
    1338: ["似似花（始原）", "ネネカ（アルファ）", "Neneka(Alpha)", "αNNK", "α花", "阿尔法花", "阿尔法nnk"],
    1339: ["克莉丝提娜（始原）", "クリスティーナ（アルファ）", "Kurisutiina(Alpha)", "α克", "阿尔法克"],
    1340: ["菲欧", "フィオ", "Fio"],
    1343: ["兰法（礼服）", "ランファ（儀装束）", "Rannfa(Dress)", "礼兰法", "礼兰"],
    1344: ["千歌（礼服）", "チカ（儀装束）", "Chika(Dress)", "礼千", "礼千歌"],
    1345: ["克萝茜（风灵）", "クローチェ（エアリアル）", "Croce(Aerial)", "火机", "火机娘"],
    1346: ["碧（驾驶员）", "アオイ（パイロット）", "Aoi(Pilot)", "白菜", "机碧"],
    1347: ["凤凰", "ホウオウ", "Phoenix", "小凤", "肥鸡"],
    1348: ["纺希（吉欧・格黑纳）", "ツムギ（ジオ・ゲヘナ）", "Tsumugi(Geo Gehenna)", "光裁"],
