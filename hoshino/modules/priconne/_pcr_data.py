...
CHARA_NAME = {
    ...
    1131: ["流夏(夏日)", "ルカ(サマー)", "Ruka(Summer)", "水大姐", "泳装大姐","水流夏"],
    1132: ["杏奈(夏日)", "アンナ(サマー)", "中二(Summer)", "水中二", "泳装中二"],
    1133: ["七七香(夏日)", "ナナカ(サマー)", "Nanaka(Summer)", "水778","水七七香","泳装七七香"],
    1134: ["初音(夏日)", "ハツネ(サマー)", "Hatsune(Summer)", "水星","海星","泳装星法"],
    1135: ["美里(夏日)", "ミサト(サマー)", "Misato(Summer)", "水母","水圣母","泳装圣母"],
