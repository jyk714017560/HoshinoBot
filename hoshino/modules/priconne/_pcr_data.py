...
CHARA_NAME = {
    ...
    1165: ["祈梨(时空旅行者)", "イノリ(タイムトラベル)", "Inori(タイムトラベル)","86","军龙锤","爱上火车","火车"],
    1166: ["嘉夜(时空旅行者)", "カヤ(タイムトラベル)", "Kaya(タイムトラベル)","军龙拳"],
    ...
    1180: ["クレジッタ", "クレジッタ", "Kurejitta", "大吉塔", "奸商", "大吉他", "富婆"],
    ...
    1207: ["雪菲(新年)", "シェフィ(ニューイヤー)", "Shefi(NewYear)", "春雪菲","春菲"],
    ...
    1214: ["美咲(舞台)", "ミサキ(ステージ))", "Misaki(Stage)", "舞台大眼","舞台👀","舞台👁️","舞眼","舞台👁","泥头车美咲","泥头车"],
    1215: ["步未(怪盗)", "アユミ(怪盗)", "Ayumi(Kaitou)", "怪盗路人妹"],
    1216: ["祈梨(怪盗)", "イノリ(怪盗)", "Inori(Kaitou)", "怪盗龙锤", "忍龙"],
    1219: ["杏奈(海盗)", "アンナ(パイレーツ)", "Anna(Pirate)", "海盗中二"],
    1220: ["忍(海盗)", "シノブ（パイレーツ）", "Shinobu(Pirate)", "海盗忍"],
    ...
    1802: ["优衣(公主)", "ユイ(プリンセス)", "Yui(Princess)", "公主优衣", "公主yui", "公主种田", "公主田", "公主ue", "掉毛优衣", "掉毛yui", "掉毛ue", "掉毛", "飞翼优衣", "飞翼ue", "飞翼", "飞翼高达", "毛衣", "羽衣", "吊毛"],
